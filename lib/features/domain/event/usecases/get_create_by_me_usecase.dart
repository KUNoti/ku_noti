...
class GetCreateByMeUseCase implements UseCase<DataState<List<EventEntity>>, int> {
  final EventRepository _eventRepository;
  GetCreateByMeUseCase(this._eventRepository);
  ...
  Future<DataState<List<EventEntity>>> call({int? params}) {
    ...
    return _eventRepository.getCreateByMe(params);
  }
}