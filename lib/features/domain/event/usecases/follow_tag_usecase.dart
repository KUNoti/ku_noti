...
class FollowTagUseCase implements UseCase<DataState<String>, FollowTagRequest> {
  final EventRepository _eventRepository;
  FollowTagUseCase(this._eventRepository);
  ...
  Future<DataState<String>> call({FollowTagRequest? params}) {
    ...
    return _eventRepository.followTag(params);
  }
}